...
#pragma mark 中间View
    ...
    float interval = 15;//label之间间隔
    float editViewHeight = 280;//中间view高度
    typeId=0;
    ...
    titleLabel = [[UILabel alloc] initWithFrame:CGRectMake(85, interval-3, 200, labelHeight+6)];
    ...
    UIImageView *rightArrow = [[UIImageView alloc] initWithFrame:CGRectMake(titleLabel.right-titleLabel.left-12, (labelHeight+6-15)/2, 9, 15)];
...
//    dayLabel.textColor = [UIColor lightGrayColor];
    [editSupplyView addSubview:dayLabel];
    
    UIImageView *downArrow = [[UIImageView alloc] initWithFrame:CGRectMake(dayLabel.right-dayLabel.left-18, (labelHeight+6-12)/2+2, 15, 9)];
    [downArrow setImage:[UIImage imageNamed:@"downArrow"]];
    [dayLabel addSubview:downArrow];
    ...
    catNameLabel = [[UILabel alloc] initWithFrame:CGRectMake(85, (interval+labelHeight)*3+interval-3, 177, labelHeight+6)];
    ...
    UIImageView *plusImgView = [[UIImageView alloc] initWithFrame:CGRectMake(catNameLabel.right, catNameLabel.top, 23, 26)];
...
#pragma mark 下面View
    UIView *contactView = [[UIView alloc] initWithFrame:CGRectMake(0, editSupplyView.bottom+10, kMainScreenWidth, 70)];
    [scrollView addSubview:contactView];
    contactView.backgroundColor = [UIColor whiteColor];
    
    UILabel *personNameLabel = [[UILabel alloc] initWithFrame:CGRectMake(10, 10, 75, 20)];
    personNameLabel.font = kFont15;
    personNameLabel.text = @"联 系 人 : ";
    
    UILabel *phoneLabel = [[UILabel alloc] initWithFrame:CGRectMake(personNameLabel.left, personNameLabel.bottom+10, 75, 20)];
    phoneLabel.font = kFont15;
    phoneLabel.text = @"联系电话 : ";
    
    nameTextField = [[UITextField alloc] initWithFrame:CGRectMake(contentTextView.left, personNameLabel.top-3, 200, labelHeight+6)];
    ...
    phoneTextField = [[UITextField alloc] initWithFrame:CGRectMake(contentTextView.left, phoneLabel.top-3, 200, labelHeight+6)];
    ...
    UIButton *publishBtn = [[UIButton alloc] initWithFrame:CGRectMake(10, contactView.bottom+10, kMainScreenWidth-20, 35)];
